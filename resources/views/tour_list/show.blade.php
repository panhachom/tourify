  ...
  <div class="slider-section mt-16">
    ...
    <div class="flex flex-wrap justify-center sm:justify-between items-center option_type pt-12">
      <div class="ps-10 w-full sm:w-1/2 md:w-auto">
        <!-- description -->
        <div class="">
          <p class="text-3xl font-medium text-muny pb-5">About this tour</p>
        </div>
