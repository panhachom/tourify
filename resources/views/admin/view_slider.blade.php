    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            <tr class="bg-white border-b ">
                ...
                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap text-center ">1</th>
                <td class="px-6 py-4 text-center"> 30% Discount</td>
                <td class="px-6 py-4 text-center"> 30% Discount សម្រាប់ការកក់ដំណើរកំសាន្តដំបូង </td>
                <td class="px-6 py-4 text-center">...</td>
                <td class="px-6 py-4 text-center">21-04-2023</td>
                <td class="px-6 py-4 text-center">25-04-2023</td>
                <td class="px-6 py-4 text-center">
                    <a href="/" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                    <a href="/" class=" ml-2 font-medium text-red-600 dark:text-red-500 hover:underline">Delete</a>
                </td>
            </tr>
            <tr class="bg-white border-b ">
                <td class="w-4 p-4">
                ...
                <th scope="row" class="px-6 py-4 font-medium text-primary whitespace-nowrap text-center">2</th>
                <td class="px-6 py-4 text-center"> 10% Discount</td>
                <td class="px-6 py-4 text-center"> For Family Trip </td>
                <td class="px-6 py-4 text-center">...</td>
                <td class="px-6 py-4 text-center">27-04-2023</td>
                <td class="px-6 py-4 text-center">30-04-2023</td>
                <td class="px-6 py-4 text-center">
                    <a href="/" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                    <a href="/" class=" ml-2 font-medium text-red-600 dark:text-red-500 hover:underline">Delete</a>
                </td>
