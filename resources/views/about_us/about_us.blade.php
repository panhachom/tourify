...
<section class=" text-gray-700 body-font bg-white">
  <div class="flex">
    <div class="flex-1">
        <div class="container mx-auto  px-5 md:px-40 py-24 md:flex-row flex-col  inline-block">
           <div class=" ">
     ...
     <div class=" m-28 ">
      ...
      <a href="" target="_blank">
        <img class="object-cover object-center rounded" alt="tip_book" src="https://static.euronews.com/articles/stories/07/40/04/18/1000x563_cmsv2_18031e1e-5231-5c9c-b555-bd4896b64b04-7400418.jpg">
      </a>
    </div>
    </div>
</div>
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
      ...
      <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
          <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
                  <img class="w-72 h-56 rounded-lg sm:rounded-none sm:rounded-l-lg" src="{{ asset('images/Panha.jpg') }}" alt="nita">
              </a>
              <div class="p-5">
                  <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                      <a href="#">Chom Panha</a>
                  </h3>
                  <span class="text-gray-500 dark:text-gray-400">Team-Leader</span>
          ...
          <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
                  <img class="w-72 h-56 rounded-lg sm:rounded-none sm:rounded-l-lg" src="{{ asset('images/p.jpg') }}" alt="nita">
              </a>
              <div class="p-5">
                  <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                      <a href="#">Ren Sonita</a>
                  ...
                  <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">Sonita drives the technical strategy of the flowbite platform and brand.</p>
                  <ul class="flex space-x-4 sm:mt-0">
                   <li>
                      <a href="#" class="text-[#39569c] hover:text-gray-900 dark:hover:text-white">
                          <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" /></svg>
          ...
          <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
                   <img class="w-72 h-56 rounded-lg sm:rounded-none sm:rounded-l-lg" src="{{ asset('images/setha.jpg') }}" alt="nita">
              </a>
              <div class="p-5">
                  <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                      <a href="#">Meanith Setha</a>
                  </h3>
